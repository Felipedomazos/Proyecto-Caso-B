...
const inputs = document.querySelectorAll('#formulario_contacto input');

const expresiones = {
	mensaje: /^[a-zA-Z0-9\_\-\,\ ]{5,100}$/, // Letras, numeros, guion y guion_bajo
...
formulario_contacto.addEventListener('submit', (e) => {
	...
	if(campos.mensaje && campos.nombre && campos.correo && campos.telefono && terminos.checked ){
		formulario.reset();
